...
/**
 * Botó per generar o mostrar l'informe de parelles
 * @type {HTMLButtonElement}
 */
const botoInformeParelles = document.getElementById('boto_informe_parelles');

/**
 * Contenidor de la informació de parelles de la sessió
 * @type {HTMLElement}
 */
...
/**
 * Formata una data per a l'informe en format català (dd/mm/yyyy)
 * @param {string|Date} data - Data a formatar
 * @returns {string} Data formatada o '-' si no és vàlida
 */
...
/**
 * Retorna un text vàlid o una alternativa si està buit
 * @param {*} valor - Valor a convertir en text
 * @param {string} [alternativa='-'] - Text alternatiu si el valor és buit
 * @returns {string} Text final
 */
...
/**
 * Retorna la classe CSS per al badge segons l'estat
 * @param {string} estat - Estat de la parella (activa, pausada...)
 * @returns {string} Classe CSS corresponent
 */
...
/**
 * Calcula el resum d'estats de les parelles
 * @returns {Object} Objecte amb el recompte d'estats
 * @returns {number} returns.total - Nombre total de parelles
 * @returns {number} returns.actives - Nombre de parelles actives
 * @returns {number} returns.pausades - Nombre de parelles pausades
 * @returns {number} returns.tancades - Nombre de parelles tancades
 */
...
/**
 * Dibuixa el peu de pàgina de l'informe PDF amb numeració
 * @param {Object} doc - Instància de jsPDF
 */
...
/**
 * Genera un informe PDF amb la llista de parelles
 * Inclou resum d'estats i taula detallada
 */
...
/**
 * Comprova si un usuari té una parella oberta (activa o pausada)
 * @param {Object} usuari - Usuari a comprovar
 * @param {number|string} usuari.perfil_id - Identificador del perfil de l'usuari
 * @returns {boolean} True si té una parella oberta, false en cas contrari
 */
